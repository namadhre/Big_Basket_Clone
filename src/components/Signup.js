...
class Signup extends Component {
    ...
    handleSecondSubmit = (event) => {
        ...
        if (count === 3) {
            this.setState({
                ...
                userName: `Hello ${this.state.firstName}`,
    ...
    render() {
        return (
            <>
                <button type="button" className="btn btn-light btn-sm97 m-4" data-toggle="modal" data-target="#sign-up">
                <i className="fa-solid fa-user"></i> {this.state.userName}
                </button>
                ...
                <div className="modal fade mt-4" id="sign-up" tabIndex="-1" role="dialog" aria-labelledby="sign-up" aria-hidden="true">
                    <div className="modal-dialog" role="document">
                        <div className="modal-content d-flex flex-row">
                            {this.state.isAllDetailsFilled === false &&
                            ...
                            {this.state.isAllDetailsFilled === true &&

                                <div className='main-container d-flex align-items-center justify-content-center model-content'>
                                    <div className='signup-container d-flex flex-column justify-content-center align-items-center'>
                                        <h1 className='h1'>Log in success</h1>
                                        <h2>Please click on below button</h2>
